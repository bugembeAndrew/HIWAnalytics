...
class ArtCall(models.Model):
    ...
    #hf_last_visit = models.ForeignKey('HealthFacility',  models.DO_NOTHING, name = 'hf_last_visit', db_column='hf_last_visit', blank=True, null=True )
    date_next_visit_hf = models.DateTimeField(blank=True, null=True)
    #hf_next_visit = models.ForeignKey('HealthFacility',  models.DO_NOTHING, name = 'hf_next_visit', db_column='hf_next_visit', blank=True, null=True )
